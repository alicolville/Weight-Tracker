                    ...
                    <div class="postbox">
						...
						<div style="padding: 0px 15px 0px 15px">
							...
							<div class="ws-ls-user-preview">
								<a href="<?php echo admin_url('admin.php?page=ws-ls-license'); ?>"><img src="<?php echo plugins_url( 'images/data-summary.jpg', __FILE__ ); ?>" /></a>
								<a href="<?php echo admin_url('admin.php?page=ws-ls-license'); ?>"><img src="<?php echo plugins_url( 'images/user-card.jpg', __FILE__ ); ?>" /></a>
							</div>
						</div>
					</div>
				</div>
