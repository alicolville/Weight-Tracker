...
function ws_ls_config_js() {
	...
	$config = [     'us-date'                           => ( $use_us_date ) ? 'true' : 'false',
					...
					'is-pro'                            => ( ( defined('WS_LS_IS_PREMIUM') && WS_LS_IS_PREMIUM ) ) ? 'true' : 'false',
					'user-id'                           => $user_id,
					...
					'form-load-previous'                => false === is_admin() && ( defined('WS_LS_IS_PREMIUM') && WS_LS_IS_PREMIUM ) && ws_ls_option_to_bool( 'ws-ls-populate-form-with-values-on-date' ),
