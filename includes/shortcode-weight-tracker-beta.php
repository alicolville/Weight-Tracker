...
function ws_ls_shortcode_beta( $user_defined_arguments ) {
	...
	$shortcode_arguments = shortcode_atts( [    'active-tab'                => 'home',                      // Initial active tab
												...
												'summary-boxes-summary'     => 'name-and-email,start-weight,start-bmi,activity-level,age-dob,target-weight,bmi,height,group,latest-versus-start,aim,gender', // Summary boxes to display at top of data tab
