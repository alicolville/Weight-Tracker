...
function ws_ls_shortcode_wt( $user_defined_arguments ) {
	...
	$shortcode_arguments[ 'show-tab-awards' ]       = ( false === ws_ls_to_bool( $shortcode_arguments[ 'hide-tab-awards' ] ) && true === ( defined('WS_LS_IS_PREMIUM') && WS_LS_IS_PREMIUM ) );
	$shortcode_arguments[ 'show-tab-advanced' ]     = ( false === ws_ls_to_bool( $shortcode_arguments[ 'hide-tab-advanced' ] ) && true === ( defined('WS_LS_IS_PREMIUM') && WS_LS_IS_PREMIUM ) );
	...
	if ( true !== ws_ls_to_bool( $shortcode_arguments[ 'hide-notifications' ] ) && true === ( defined('WS_LS_IS_PREMIUM') && WS_LS_IS_PREMIUM ) ) {
