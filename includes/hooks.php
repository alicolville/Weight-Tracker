...
function ws_ls_enqueue_files(){
	...
	// Tabs enabled?
	wp_enqueue_style( 'wlt-font-awesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', [], WE_LS_CURRENT_VERSION );
...
function ws_ls_enqueue_admin_files(){
    ...
    wp_enqueue_script( 'ws-ls-admin', plugins_url( '../assets/js/admin.js', __FILE__ ), [ 'jquery' ], WE_LS_CURRENT_VERSION );
