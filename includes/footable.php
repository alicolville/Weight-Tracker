...
function ws_ls_data_table_enqueue_scripts() {
	...
	wp_enqueue_style('ws-ls-footables', WS_LS_BASE_URL . '/assets/css/libraries/footable.standalone.min.css', [], WE_LS_CURRENT_VERSION);
    wp_enqueue_style('ws-ls-footables-wlt', WS_LS_BASE_URL . 'assets/css/footable' . $minified . '.css', [ 'ws-ls-footables' ], WE_LS_CURRENT_VERSION);
    wp_enqueue_script('ws-ls-footables-js', WS_LS_BASE_URL . 'assets/js/libraries/footable.min.js', [ 'jquery' ], WE_LS_CURRENT_VERSION, true);
