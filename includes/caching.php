...
function ws_ls_cache_generate_key( $key ){
	...
	return sprintf( 'wt-%s-%s-%s-%d-%s',  ( defined('WS_LS_IS_PREMIUM') && WS_LS_IS_PREMIUM ), ( defined('WS_LS_IS_PREMIUM') && WS_LS_IS_PREMIUM ), WE_LS_CURRENT_VERSION, $cache_version, $key );
}
