...
(function (global, factory) {
    ...
    */
    ...
    // register components
    each(components$1, function (component, name) { return ykukUIkit.component(name, component); }
    );
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, 'ykuk-invisible', this$1$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1$1.maxIndex));
                });
    ...
    var LightboxPanel = {
        ...
        methods: {
            ...
            showControls: function() {
                ...
                addClass(this.$el, 'ykuk-active', 'ykuk-transition-active');

            },

            hideControls: function() {
                removeClass(this.$el, 'ykuk-active', 'ykuk-transition-active');
            }
    ...
    function install$1(ykukUIkit, Lightbox) {
