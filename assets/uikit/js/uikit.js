...
(function (global, factory) {
    ...
    */
    ...
    // register components
    each(components$1, function (component, name) { return yk-uiUIkit.component(name, component); }
    );
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, 'yk-ui-invisible', this$1$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1$1.maxIndex));
                });
    ...
    var LightboxPanel = {
        ...
        methods: {
            ...
            showControls: function() {
                ...
                addClass(this.$el, 'yk-ui-active', 'yk-ui-transition-active');

            },

            hideControls: function() {
                removeClass(this.$el, 'yk-ui-active', 'yk-ui-transition-active');
            }
    ...
    function install$1(yk-uiUIkit, Lightbox) {
