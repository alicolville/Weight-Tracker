...
jQuery( document ).ready(function ($) {
    ...
    //TODO: Copt to main file and minimise
    ...
    function ws_ls_meta_fields_show_additional() {
        ...
        meta_field_ids.forEach(element => {

            if ( element == value ) {
                $('#ws-ls-meta-fields-additional-' + element ).removeClass( 'ws-ls-hide' );
            } else {
                $('#ws-ls-meta-fields-additional-' + element ).addClass( 'ws-ls-hide' );
            }
