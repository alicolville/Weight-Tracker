...
* Removed some legacy references to Pro Plus rather than Premium.
...
* Improvement: Added "Email Address" to CSV exports.
...
* Bug fix: Fire data to web hooks (if enabled) on GravityForm submissions.
...
* Bug fix: Fixed an issue where photo uploads weren't allowed when "hide from shortcodes" was selected.
