...
|show-target|If set to false, the target weight shall be hidden from the chart.|True or false.|[wt-chart show-target=false]
|show-weight|If set to false, the weight entries shall be hidden from the chart.|True or false.|[wt-chart show-weight=false]
