...
function ws_ls_shortcode_if($user_defined_arguments, $content = null) {
	...
	$arguments = shortcode_atts(array(
		...
		'field' => 'weight'					// weight, target, bmr, height, gender, activity-level, dob
	...
	$arguments['field'] = (true === in_array($arguments['field'], ['weight', 'target', 'bmr', 'height', 'gender', 'activity_level', 'dob'])) ? $arguments['field'] : 'exists';
