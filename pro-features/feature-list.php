...
function ws_ls_feature_list_pro_plus() {
	return [
		...
		__( '<strong>[wt-kiosk]</strong> - allowing your administrators and staff to search and edit a user\'s record on the front end of your website.' , WE_LS_SLUG ),
		__( '<strong>Barcode scanner</strong> - Beta. Barcode scanner for scanning user IDs when using [wt-kiosk].' , WE_LS_SLUG ),
