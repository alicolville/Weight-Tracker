                ...
                $html_output .= '<tr>
                            ...
                            <td>' . $weight_object['kg'] . '</td>
														<td class="ws-ls-table-options">
															<!--
																<img src="' . plugins_url( '../css/images/edit.png', __FILE__ ) .'" data-row-id="' . $weight_object['db_row_id'] . '" class="ws-ls-edit-row" />
																<img src="' . plugins_url( '../css/images/delete.png', __FILE__ ) .'" class="ws-ls-delete-row" />
															-->
														</td>
                          </tr>';
      }
...
//TODO: REMOVE
function ws_ls_advanced_table_test()
{
	return '

		<table id="ws-ls-main-data-table" class="display ws-ls-advanced-data-table nowrap" cellspacing="0" width="100%">
			<thead>
            <tr>
                <th>First name</th>
                <th>Last name</th>
